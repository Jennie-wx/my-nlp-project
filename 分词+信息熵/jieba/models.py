    ...
    def getCorpus(self, rootDir):
        ...
        for file in listdir:
            ...
            if os.path.isfile(path):
                with open(os.path.abspath(path), "r", encoding='gb18030', errors='ignore') as file:
...
if __name__ == '__main__':
    path="/Users/wangxin/Desktop/fencitry/AM"
    tra = TraversalFun("/Users/wangxin/Desktop/fencitry/AM")
